...
exclusions:
  ...
  - path: '%ProgramFiles%\Citrix\Broker\Service\Setup Scripts\BackupDesktopServerKeys.ps1'
    ...
    description: ''
    justification: ''
  - path: '%ProgramFiles%\Citrix\Broker\Service\Setup Scripts\ConfigureHighAvailabilityService.ps1'
    type: File
    description: ''
    justification: ''
  - path: '%ProgramFiles%\Citrix\Broker\Service\Setup Scripts\RestoreDesktopServerKeys.ps1'
    type: File
    description: ''
    justification: ''
